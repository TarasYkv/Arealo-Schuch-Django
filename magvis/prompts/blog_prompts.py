...
NATURMACHER_VOICE = (
    ...
    "  Anlass (Pensionierung, Geburtstag, Abschied, Promotion, Hochzeit), (c) ein\n"
    "  spezifisches Detail (welche Gravur, welche Reaktion).\n"
    "- Format-Beispiele (variieren, NICHT 1:1 kopieren):\n"
    "  • 'Klaus bestellte einen Topf mit der Gravur \"Bauingenieur des Jahres\" zur\n"
    "    Pensionierung seines Schwiegervaters — die Familie schickte uns spaeter\n"
    "    ein Foto vom geschmueckten Geburtstagstisch.'\n"
    "  • 'Sabine erzaehlte uns, sie habe drei Versuche gebraucht, bis der\n"
    "    Spruch fuer den Abschiedstopf ihrer Kollegin perfekt sass.'\n"
    "  • 'Aus einer Bestellung von Tobias zur Promotion seines Bruders wissen wir:\n"
    "    eine kurze, persoenliche Botschaft wirkt staerker als ein langer Spruch.'\n"
    "- Nicht jede Sektion braucht eine Anekdote — aber 0 Anekdoten im ganzen\n"
    "  Beitrag ist NICHT akzeptabel.\n\n"
    "STIL:\n"
