...
# Bing Image Search API für LoomMarket Bildersuche (pro User in DB)
# Erstelle Ressource: https://portal.azure.com/#create/microsoft.bingsearch
# 1000 kostenlose Anfragen/Monat (F0 Tier)
