...
def migrate_keywords_to_default_lists(apps, schema_editor):
    """
    Erstellt für jeden User eine Standard-Liste und verschiebt alle Keywords dorthin
    """
    ...
    for user_id in users_with_keywords:
        # Erstelle Default-Liste für diesen User
...
def reverse_migration(apps, schema_editor):
    """
    Reverse: Setze keyword_list auf NULL zurück
    """
    SavedKeyword = apps.get_model('keyengine', 'SavedKeyword')
