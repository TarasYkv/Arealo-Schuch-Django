...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('ai_model', models.CharField(choices=[('openai_gpt4', 'OpenAI GPT-4'), ('openai_gpt35', 'OpenAI GPT-3.5'), ('google_gemini', 'Google Gemini'), ('anthropic_claude', 'Anthropic Claude')], help_text='Verwendetes KI-Modell', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('unit', models.CharField(blank=True, help_text='Einheit (Stk, m², kg, etc.)', max_length=50)),
