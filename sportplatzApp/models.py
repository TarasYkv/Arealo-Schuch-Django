...
class Komponente(models.Model):
    """
    Dieses Modell repräsentiert ein einzelnes Bauteil, z.B. eine bestimmte Leuchte
    oder eine Traverse.
    """
    KATEGORIEN = [
        ('LEUCHTE', 'Leuchte'),
...
class Variante(models.Model):
    """
    Dieses Modell repräsentiert eine komplette Konfiguration (eine Spalte aus deiner Tabelle).
    Es verweist auf spezifische Komponenten und enthält auch Preisinformationen.
    """
...
class Projekt(models.Model):
    """
    Dieses Modell speichert die ursprüngliche Bestandsaufnahme und die vom System
    ermittelte, passende Variante.
    """
