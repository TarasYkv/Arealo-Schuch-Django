    ...
    def generate_pot_image(self, engraving_text: str, scene_description: str,
        ...
        if base_pot_image_path:
            prompt = (
                ...
                f"\n\n### REFERENZBILD-TREUE (HÖCHSTE PRIORITÄT): ###"
                f"\nDas Referenzbild zeigt den EXAKTEN Blumentopf mit der EXAKTEN Gravur. "
                f"Übernimm aus dem Referenzbild 1:1: Form, Farbe, Material, Proportionen, "
                f"Schriftart, Schriftgröße, Wortlaut, Position der Gravur, Logo (falls vorhanden). "
                f"KEINE VARIATIONEN am Motiv. Der Text '{engraving_text}' muss EXAKT identisch "
