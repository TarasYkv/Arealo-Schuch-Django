    ...
    try:
        with transaction.atomic():
            ...
            product = PLoomProduct.objects.create(
                ...
                product_category=settings_obj.default_product_category if settings_obj else '',
                product_category_name=settings_obj.default_product_category_name if settings_obj else '',
                collection_id=settings_obj.default_collection_id if settings_obj else '',
                collection_name=settings_obj.default_collection_name if settings_obj else '',
