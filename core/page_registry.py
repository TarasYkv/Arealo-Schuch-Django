...
def get_system_page_choices() -> List[Tuple[str, str]]:
    ...
    order_keys = [
        ...
        'accounts_dashboard', 'mail_dashboard', 'shopify_dashboard', 'organization_dashboard',
        'naturmacher_dashboard', 'videos_dashboard', 'chat_dashboard', 'email_templates_dashboard', 'fileshare_dashboard',
