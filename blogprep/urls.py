...
urlpatterns = [
    ...
    path('api/check-blog-articles/', views.api_check_blog_articles, name='api_check_blog_articles'),
    ...
    path('api/update-section-image-alt/<uuid:project_id>/', views.api_update_section_image_alt, name='api_update_section_image_alt'),
    ...
    path('api/get-all-keywords/', views.api_get_all_keywords, name='api_get_all_keywords'),
