"""
Video Studio - 4 Models on Modal
GPU is selected dynamically via the generate_video method parameter.
"""
import modal
...
# Base config: no GPU specified at class level, no keep_warm
BASE_CFG = dict(image=image, volumes={MODEL_DIR: vol}, timeout=1800, scaledown_window=30, max_containers=1)
...
class LTX2Distilled:
    ...
    @modal.method(gpu=modal.gpu.L40S())
...
class WanFLF2V:
    ...
    def load_model(self):
        ...
        # Will be set per-call based on GPU
