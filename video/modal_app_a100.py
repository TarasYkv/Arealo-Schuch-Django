...
app = modal.App("video-studio-ltx-prod-a100")
...
CLS_CFG = dict(image=image, gpu="A100-80GB", volumes={MODEL_DIR: vol}, timeout=3600, scaledown_window=30, max_containers=1)
