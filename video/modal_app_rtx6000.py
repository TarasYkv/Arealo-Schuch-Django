...
app = modal.App("video-studio-ltx-prod-rtx6000")
...
CLS_CFG = dict(image=image, gpu="RTX6000", volumes={MODEL_DIR: vol}, timeout=3600, scaledown_window=30, max_containers=1)
