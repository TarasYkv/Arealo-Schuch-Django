    ...
    def handle(self, *args, **options):
        ...
        plans = [
            ...
            # ========== 1GB PLAN ==========
            {
                ...
                'stripe_price_id': 'price_1SGN3eGDxp57VS6VQyvGHGn2',  # LIVE MODE
                'plan_type': 'storage',
                'price': Decimal('2.99'),
                'currency': 'EUR',
                'interval': 'month',
            ...
            # ========== 3GB PLAN ==========
            {
                ...
                'stripe_price_id': 'price_1SGN3kGDxp57VS6VPhJgQE3h',  # LIVE MODE
                'plan_type': 'storage',
                'price': Decimal('4.99'),
                'currency': 'EUR',
                'interval': 'month',
            ...
            # ========== 5GB PLAN ==========
            {
                ...
                'stripe_price_id': 'price_1SGN3oGDxp57VS6VopcjCHYf',  # LIVE MODE
                'plan_type': 'storage',
                'price': Decimal('7.99'),
                'currency': 'EUR',
                'interval': 'month',
            ...
            # ========== 10GB PLAN ==========
            {
                ...
                'stripe_price_id': 'price_1SGN3rGDxp57VS6VhfjSuxZ5',  # LIVE MODE
                'plan_type': 'storage',
                'price': Decimal('9.99'),
                'currency': 'EUR',
                'interval': 'month',
