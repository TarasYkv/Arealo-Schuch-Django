...
urlpatterns = [
    ...
    path('api/import-products-progress/<str:import_id>/', views.import_products_progress_view, name='import_products_progress'),
    ...
    # Backup & Restore
    path('backups/', views.backup_overview, name='backup_overview'),
    ...
    path('store/<int:store_id>/backups/<int:backup_id>/sync/<int:item_id>/', views.sync_item_from_shopify, name='sync_item_from_shopify'),
    ...
    path('api/store/<int:store_id>/backups/<int:backup_id>/items/<int:item_id>/', views.api_backup_item_detail, name='api_backup_item_detail'),
]