...
urlpatterns = [
    ...
    path('api/product-images-history/', views.api_product_images_history, name='api_product_images_history'),
    path('api/style-ref-images-history/', views.api_style_ref_images_history, name='api_style_ref_images_history'),
