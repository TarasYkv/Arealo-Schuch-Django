    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('template_type', models.CharField(choices=[('user_registration', 'Benutzer-Registrierung'), ('account_activation', 'Account-Aktivierung'), ('welcome', 'Willkommens-E-Mail'), ('password_reset', 'Passwort zurücksetzen'), ('password_changed', 'Passwort geändert'), ('login_notification', 'Login-Benachrichtigung'), ('storage_warning', 'Speicherplatz-Warnung'), ('storage_grace_period_start', 'Speicher-Kulanzzeit gestartet'), ('storage_grace_period_warning', 'Speicher-Kulanzzeit Warnung'), ('storage_grace_period_end', 'Speicher-Kulanzzeit beendet'), ('videos_archived', 'Videos archiviert'), ('files_archived', 'Dateien archiviert'), ('backup_notification', 'Backup-Benachrichtigung'), ('subscription_created', 'Abonnement erstellt'), ('subscription_renewed', 'Abonnement verlängert'), ('subscription_cancelled', 'Abonnement gekündigt'), ('subscription_expired', 'Abonnement abgelaufen'), ('payment_successful', 'Zahlung erfolgreich'), ('payment_failed', 'Zahlung fehlgeschlagen'), ('invoice', 'Rechnung'), ('payment_reminder', 'Zahlungserinnerung'), ('trial_ending', 'Testphase endet bald'), ('trial_expired', 'Testphase abgelaufen'), ('order_confirmation', 'Bestellbestätigung'), ('order_shipped', 'Versandbestätigung'), ('order_delivered', 'Lieferbestätigung'), ('order_cancelled', 'Stornierungsbestätigung'), ('cart_abandoned', 'Warenkorb verlassen'), ('product_review_request', 'Produktbewertung anfragen'), ('return_request', 'Rücksendung-Anfrage'), ('refund_processed', 'Erstattung verarbeitet'), ('support_ticket_created', 'Support-Ticket erstellt'), ('support_ticket_updated', 'Support-Ticket aktualisiert'), ('support_ticket_resolved', 'Support-Ticket gelöst'), ('feedback_request', 'Feedback-Anfrage'), ('survey_invitation', 'Umfrage-Einladung'), ('bug_report_submitted', 'Bug-Report eingereicht'), ('bug_report_response', 'Bug-Report Antwort'), ('maintenance_notification', 'Wartungsankündigung'), ('system_update', 'System-Update'), ('security_alert', 'Sicherheitswarnung'), ('feature_announcement', 'Feature-Ankündigung'), ('service_disruption', 'Service-Unterbrechung'), ('data_breach_notification', 'Datenschutzverletzung'), ('event_invitation', 'Event-Einladung'), ('event_reminder', 'Terminerinnerung'), ('event_cancelled', 'Termin abgesagt'), ('event_rescheduled', 'Termin verschoben'), ('task_assigned', 'Aufgabe zugewiesen'), ('task_reminder', 'Aufgaben-Erinnerung'), ('task_completed', 'Aufgabe abgeschlossen'), ('task_overdue', 'Aufgabe überfällig'), ('deadline_reminder', 'Deadline-Erinnerung'), ('newsletter', 'Newsletter'), ('marketing_campaign', 'Marketing-Kampagne'), ('promotional_offer', 'Werbe-Angebot'), ('announcement', 'Ankündigung'), ('seasonal_greeting', 'Saisonale Grüße'), ('birthday_wish', 'Geburtstagsgruß'), ('anniversary', 'Jubiläum'), ('loyalty_reward', 'Treuebonus'), ('referral_invitation', 'Empfehlungs-Einladung'), ('activity_summary', 'Aktivitäts-Zusammenfassung'), ('achievement_unlocked', 'Erfolg freigeschaltet'), ('milestone_reached', 'Meilenstein erreicht'), ('inactivity_reminder', 'Inaktivitäts-Erinnerung'), ('re_engagement', 'Wiederbindungs-Kampagne'), ('notification', 'Allgemeine Benachrichtigung'), ('transactional', 'Transaktions-E-Mail'), ('reminder', 'Erinnerung'), ('confirmation', 'Bestätigung'), ('alert', 'Warnung'), ('info', 'Information'), ('custom', 'Benutzerdefiniert')], default='custom', max_length=50, verbose_name='Vorlagentyp')),
                ('is_auto_send', models.BooleanField(default=True, help_text='Template automatisch bei Trigger-Ereignis senden', verbose_name='Automatisch senden')),
                ('send_delay_minutes', models.IntegerField(default=0, help_text='Verzögerung in Minuten bevor die E-Mail gesendet wird', verbose_name='Versendungs-Verzögerung (Minuten)')),
                ('conditions', models.JSONField(blank=True, default=dict, help_text='Erweiterte Bedingungen für die Versendung (JSON)', verbose_name='Bedingungen')),
                ...
                ('trigger', models.ForeignKey(blank=True, help_text='Trigger der diese Vorlage automatisch auslöst', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='templates', to='email_templates.emailtrigger', verbose_name='E-Mail-Trigger')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(blank=True, verbose_name='Beschreibung')),
                ('client_id', encrypted_model_fields.fields.EncryptedCharField(verbose_name='Zoho Client ID')),
                ('client_secret', encrypted_model_fields.fields.EncryptedCharField(verbose_name='Zoho Client Secret')),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['-created_at'], name='email_templ_created_bff515_idx'),
        ),
        migrations.AddIndex(
            model_name='emailsendlog',
            index=models.Index(fields=['recipient_email'], name='email_templ_recipie_83f1b7_idx'),
        ),
        migrations.AddIndex(
            model_name='emailsendlog',
            index=models.Index(fields=['is_sent', '-created_at'], name='email_templ_is_sent_f54e3d_idx'),
        ),
    ]
